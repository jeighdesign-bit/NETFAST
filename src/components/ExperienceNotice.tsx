  ...
  return (
    ...
    >
      <a 
        ...
        aria-label="Download uBlock Origin"
        className="p-4 rounded-2xl border border-yellow-500/20 bg-yellow-500/10 backdrop-blur-xl flex flex-col md:flex-row items-center justify-center gap-4 text-center group hover:border-yellow-500/40 transition-all duration-500 shadow-[0_10px_40px_rgba(234,179,8,0.1)] cursor-pointer"
      >
